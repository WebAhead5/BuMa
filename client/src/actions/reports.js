...
export function fetchReports(cb) {
    callApi(null, null, 'GET', 'reports', null, FETCH_BUTTONS_SUCCESS, FETCH_BUTTONS_FAILURE, cb);
}

export function addReport(report, cb) {
    callApi(null, null, 'POST', 'add-report', report, BUTTON_UPDATE_SUCCESS, BUTTON_UPDATE_FAILURE, cb);
}

export function getReportById(id, cb) {
    callApi(null, null, 'GET', `report/${id}`, null, FETCH_BUTTONS_SUCCESS, FETCH_BUTTONS_FAILURE, cb);
}

export function deleteReport(id, cb) {
    callApi(null, null, 'GET', `delete-report/${id}`, null, FETCH_BUTTONS_SUCCESS, FETCH_BUTTONS_FAILURE, cb);
}